function showNdpCalendarBox(a) {
    if (calendarVisible) hideCalendarBox(!1);
    else {
        ndpData[a] && (ndpAttr = ndpData[a]);
        var b = $("#" + a).val();
        $("#ndp-target-id").html(a);
        var c = $("#" + a).offset();
        $("#ndp-nepali-box").css("top", c.top + $("#" + a).outerHeight()), $("#ndp-nepali-box").css("left", c.left), showCalendar(b), calendarVisible = !0
    }
}
...
function getDateRows(a, b, c, d, e) {
    for (var f = getNepaliDate(), g = f.split("/"), i = (g[0], get2DigitNo(g[1])), j = get2DigitNo(g[2]), k = "", l = 0; a + b > l; l++) {
        ...
        var m = l - a + 1,
            ...
            o = "";
        o = get2DigitNo(d) == i && j == get2DigitNo(m) ? "ndp-selected" : m == e ? "ndp-current" : "ndp-date", a > l ? k += "<td></td>\n" : (k += "<td class='" + o + "'>", k += "<a href='javascript:void(0)' onclick=\"setSelectedDay('" + n + "')\">" + englishNo2Nep(m) + "</a>", k += "</td>\n"), l % 7 == 6 && (k += "</tr>\n")
    }
    return k
}

function hideCalendarBox(a) {
    a = "undefined" != typeof a ? a : !0, $("#ndp-nepali-box").fadeOut(100), calendarVisible = !1, a && ndpAttr.onChange && ndpAttr.onChange()
}
...
function getNepaliMonth(a) {
    a = parseInt(a, 10);
    var b = new Array("\u092c\u0948\u0936\u093e\u0916", "\u091c\u0947\u0920", "\u0905\u0937\u093e\u0922", "\u0936\u094d\u0930\u093e\u0935\u0923", "\u092d\u093e\u0926\u094d\u0930", "\u0906\u0936\u094d\u0935\u093f\u0928", "\u0915\u093e\u0930\u094d\u0924\u093f\u0915", "\u092e\u0919\u094d\u0938\u093f\u0930", "\u092a\u094c\u0937", "\u092e\u093e\u0918", "\u092b\u093e\u0932\u094d\u0917\u0941\u0928", "\u091a\u0948\u0924\u094d\u0930");
    return b[a]
}
...
ndpAttr = {}, calendarVisible = "", ignoreMouseUp = !1, ndpData = [],
    function(a) {
